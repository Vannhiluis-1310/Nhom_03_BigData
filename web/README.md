...
2. Bấm **Chạy preprocessing pipeline** để chạy notebook preprocessing.
...
3. Một số model/target trong UI có thể chưa có artifact thực tế (ví dụ `DecisionTreeClassifier`, `GBTRegressor`), app sẽ báo thân thiện thay vì crash.
